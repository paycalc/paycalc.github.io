...
document.addEventListener('DOMContentLoaded',()=>{
 ...
 if(f){
  const fb=FEEDBACK_URL&&!FEEDBACK_URL.includes('PASTE')?` · <a href="${FEEDBACK_URL}" target="_blank" rel="noopener">Feedback &amp; corrections</a>`:'';
  f.innerHTML=`<b>PayCalc</b> · independent &amp; unofficial — not a Queensland Government service · award floor rates as at 1 Sep 2025 · ATO tax tables 1 Jul 2026 · built for operational shiftworkers on the OO3–OO6 12-hour continuous roster${fb}.
  <div class="disclaimer"><b>Independent &amp; unofficial.</b> PayCalc is a personal project. It is not affiliated with, endorsed by, or connected to the Queensland Government, the Department of Youth Justice and Victim Support, the Queensland Industrial Relations Commission, the Australian Taxation Office, QSuper, or any union. <b>Estimate only</b> — not financial, tax, or industrial advice. All rates come from public instruments and may be out of date. Your official payslip is the source of truth. <a href="#full-disclaimer">Read the full disclaimer</a>.</div>
  <div id="full-disclaimer" class="disclaimer">
   <p><b>Full disclaimer</b></p>
   <p><b>1. Independence.</b> PayCalc is an independent, unpaid personal project created by a private individual in their own time. It is not produced, approved, endorsed, sponsored, or maintained by the Queensland Government, the Department of Youth Justice and Victim Support (or any other department or agency), the Queensland Industrial Relations Commission, the Australian Taxation Office, QSuper, the Australian Workers’ Union, Together Queensland, the United Workers’ Union, or any other organisation. Nothing on this site is an official statement, and no content should be attributed to any of those bodies. Names of awards, agreements, departments and instruments are used only to identify the public documents the calculations are based on.</p>
   <p><b>2. Public sources only.</b> Every rate and rule shown here is taken from publicly available instruments — the Youth Detention Centre Employees Award – State 2016 (QIRC reprints), the Youth Detention Centre Certified Agreement 2023 (CB/2023/139), ATO Schedules 1 and 8, the Superannuation (State Public Sector) Regulation 2023, and Queensland Government directives. This site contains no confidential, internal, or restricted information, and it must not be relied on as an official publication of any of those instruments. Copyright in the underlying instruments remains with the State of Queensland and the Commonwealth.</p>
   <p><b>3. Estimates only — not advice.</b> All outputs are simplified per-fortnight estimates for operational shiftworkers on the OO3–OO6 12-hour continuous roster. They are general information, not financial, taxation, superannuation, legal, or industrial advice, and they do not consider your personal circumstances. Actual entitlements depend on your individual employment arrangements and the instruments as they apply to you. PAYG withholding is an estimate that reconciles at your tax return.</p>
   <p><b>4. No guarantee of accuracy or currency.</b> Rates change — certified agreements are negotiated and certified, State Wage Cases move award rates (usually each September), and the ATO reissues tax tables (usually each July). The site may contain errors or stale rates at any time, and it is provided “as is” without warranty of any kind. Payroll may also legitimately pay above the award floor shown here.</p>
   <p><b>5. Your payslip wins.</b> Your official payslip, QSuper statements, and the instruments themselves are the only authoritative sources. If this calculator and your payslip differ, rely on the payslip. For pay problems, underpayments, or advice about your entitlements, contact your payroll/HR area, your union, or an appropriately qualified adviser — not this site.</p>
   <p><b>6. Liability.</b> To the maximum extent permitted by law, the author accepts no liability for any loss, underpayment, tax outcome, or decision arising from use of, or reliance on, this site. You use it entirely at your own risk and are responsible for verifying every figure. Nothing in this disclaimer excludes any right or guarantee under the Australian Consumer Law that cannot lawfully be excluded.</p>
   <p><b>7. Privacy.</b> This site runs entirely in your browser. Nothing you type is collected, stored, transmitted, or shared — there are no accounts, no analytics, and no server. Saving “your copy” downloads a file to your own device; nothing leaves the page.</p>
  </div>`;
 }
